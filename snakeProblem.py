...
# numGenerations
# population
# individual (= SnakePlayer ? - what is the list parameter for ?)
# terminalSet (= snake movements)
# primitiveSet (= snake sensing)
# evaluation function (should run current snake and return its score)
